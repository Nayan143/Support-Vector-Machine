...
def leastSquares(data, label):
    ...
    #The function that trains a least-squares classifier based on a data matrix 	data and its class label vector label. It provides as output the linear 	classifier weight vector weight and bias.
