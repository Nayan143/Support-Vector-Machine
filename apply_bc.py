...
print(X, t, C)
# To retrain, use the following two lines _instead_ of the load
...
plt.show()
# 
# train error 12 on _full_ dataset, test errors vary largely by choice of test set... thus, there is no "correct" number.
