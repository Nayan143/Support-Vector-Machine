...
def svmkern(X, t, C, p):
    ...
    # compared to 1e-8, which is the tolerance within which
    ...
    if ~sv.any():
        ...
        # Hence alpha checked within the range of [C-1e-8, C]
