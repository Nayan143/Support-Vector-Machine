...
def svmlin(X, t, C):
    ...
    # compare to 1e-6, which is the tolerance within which cvxopt.solvers satisfies the constraints.
    ...
    if ~sv.any():
        ...
        # Hence checked alpha within the range of [C-1e-6, C]
        ...
        # Compute bias by averaging over all support vectors
